...
def getOTPApi(number):
    account_sid='your acc num of twilio'
    auth_token ='your auth token of twilio'
...
def upload():
    if 'loggedin' in session:
        if request.method=='POST':
            ...
            selling_pricehigh=0
            import csv
            f=open('C:/Users/pranj/Downloads/finalminiproj/flask/phase3mydata.csv','r')
            reader=csv.reader(f)
            l=[]
            for row in reader:
                l.append(row)
